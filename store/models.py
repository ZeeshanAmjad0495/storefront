...
class Order(models.Model):
    ...
    PAYMENT_STATUS_CHOICES = [(PAYMENT_PENDING, 'Pending'), (PAYMENT_COMPLETE, 'Complete'), (PAYMENT_FAILED, 'Failed')]
...
class OrderItem(models.Model):
    ...
    produc = models.ForeignKey(Product, on_delete=models.PROTECT)
